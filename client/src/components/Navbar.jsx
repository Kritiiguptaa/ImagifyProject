...
//--------NOTES-----------
//Main logic:
//Left Side of NavBar(name,img): constant
//Right side: Dynamic according to if user has logged in or not
//i.e user? logged in:or not

//Tailwind
// hover:scale-105 → Slight zoom effect when hovered.
// transition-all duration-700 → Smooth transition over 700ms.
